...
/**
 * Polls unpublished outbox rows and relays them to RabbitMQ. See ADR-002. Until RabbitMQ is
 * wired into the docker-compose stack, publish attempts fail (connection refused) and are
 * retried on the next tick — expected/documented behavior for standalone-service development
 * ahead of that phase, not a bug.
 */
@Component
