...
/**
 * A4: limits new WebSocket handshakes per client IP (fixed window). See game-engine's equivalent —
 * this is an intentional per-service duplicate (services can't share code beyond jwt-validation-lib).
 */
@Component
