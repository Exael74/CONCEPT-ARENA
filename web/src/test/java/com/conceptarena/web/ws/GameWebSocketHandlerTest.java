 ...
 * handshake resolved from the JWT (JwtHandshakeInterceptor), never a userId claimed in the
...
class GameWebSocketHandlerTest {
    ...
    private void authenticateSessionAs(String userId) {
        ...
        attributes.put(JwtHandshakeInterceptor.WS_USER_ID_ATTRIBUTE, userId);
