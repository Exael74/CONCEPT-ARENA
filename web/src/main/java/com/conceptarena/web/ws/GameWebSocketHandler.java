...
public class GameWebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        // The handshake (JwtHandshakeInterceptor) already authenticated this session and
        ...
        String userId = (String) session.getAttributes().get(JwtHandshakeInterceptor.WS_USER_ID_ATTRIBUTE);
        if (userId == null) {
