...
public class Room {
    ...
    private Room(EntityId id, String name, RoomType type, String inviteCode, String conceptBankId, int maxParticipants, RoomStatus status) {
        this.id = id;
        this.name = name;
        this.type = type;
    ...
    public static Room create(String name, RoomType type, String inviteCode, String conceptBankId, int maxParticipants) {
        ...
        return new Room(EntityId.generate(), name.trim(), type, inviteCode, conceptBankId, maxParticipants, RoomStatus.WAITING);
    }

    public static Room restore(EntityId id, String name, RoomType type, String inviteCode, String conceptBankId, int maxParticipants, RoomStatus status) {
        return new Room(id, name, type, inviteCode, conceptBankId, maxParticipants, status);
    }
